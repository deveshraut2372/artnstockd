...
//    private  List tempDeleteList;

    //change
    private List<String> cartProductMaster;

    private List<String> cartArtFrameMaster;

    private List<String> cartAdminArtProductMaster;
